...
def get_roster(team_key, season: int) -> pd.DataFrame:
    ...
    s_col = 'season_id' if 'season_id' in df_active.columns else 'season' if 'season' in df_active.columns else None
    if s_col:
        active = df_active[(df_active['team_id'] == tid) & (df_active[s_col] == season)]
    else:
    ...
    s_col_inact = 'season_id' if 'season_id' in df_inact.columns else 'season' if 'season' in df_inact.columns else s_col
    if s_col_inact:
